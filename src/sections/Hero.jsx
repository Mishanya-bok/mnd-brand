  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-[#E8EEF8]/55 via-transparent to-[#E8EEF8]/88" />
        <div className="absolute inset-0 bg-gradient-to-r from-[#E8EEF8]/45 via-transparent to-transparent" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full px-6 pb-20 md:pb-28 pt-36">
        <div className="max-w-3xl">
          ...
          <motion.h1
            ...
            className="font-display font-extrabold leading-[0.92] tracking-tight text-[var(--ink)] mb-6"
            style={{ fontSize: 'clamp(54px, 10vw, 118px)' }}
          >
            для тех,
            <br />
            кто{' '}
          ...
          >
            <a
              ...
              style={{ background: 'var(--lime)', boxShadow: '0 8px 32px rgba(170,255,0,0.3)' }}
            >
              Смотреть дроп
        ...
        >
          <p className="text-xs tracking-widest uppercase text-[var(--ink-faint)] font-semibold">
            worn by creators
          </p>
        </motion.div>
      </div>
